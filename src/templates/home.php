...
fbq('init', '315344192904128');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=315344192904128&ev=PageView&noscript=1"
/></noscript>
...
<?php include 'templates/fixed/header.php';?>
    <div class="guide_container">
        <img src="https://cdainterview.com/resources/cda-interview-guide.jpg" alt="Snow" style="width:100%;">
        <div class="guide_text">CDA Interview Guide</div>
    </div>
    <div class="container">
    	<h3 id = "guide_title">Ultimate Guide to CDA Structured Interview: Tips & Proven Strategies to Help You Prepare & Ace Your CDA Interview</h3>
        <h3>Overview:</h3>
        <p class ="overview"><span>The purpose of the dental school interview</span>
           <span>History and rationale of the CDA interview</span>
           <span>Types of Questions </span>
           <span>The Seven Competencies </span>
           <span>Structure of the CDA interview</span></p>
        </p>
        <div class = "faqs">
            <a href="#">How to prepare for your CDA Interview</a>
            <a href="#">Sample CDA interview questions</a>
            <a href="#">BeMo CDA-structured interview prep program</a>
            <a href="#">Contact us</a>
        </div>
        ...
        <p>Click<a class="more_details_link" href = "#" >here</a>to learn how to prepare for your CDA interview</p>
        <p>Click<a class="more_details_link" href = "#">here</a>to practice with our sample CDA interview questions</p>
        <p>Click<a class="more_details_link" href = "#">here</a>to learn more about our money-back guarantee CDA interview preparation programs.</p>
